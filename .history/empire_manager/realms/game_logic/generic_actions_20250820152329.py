...
def calculate_produce_goods_cost(realm, good_type_id, resource_id=None, quantity=1):
    ...
    try:
        ...
        elif good_type.required_resource_category and resource_id:
            resource_to_use = Resource.objects.get(id=resource_id, category=good_type.required_resource_category)

        print(resource_to_use) # Debugging output
