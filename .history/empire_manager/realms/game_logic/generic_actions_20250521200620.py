...
def get_buy_resources_details():
    return {
        "name": "Buy Resources",
        "slug": "buy_resources", # Add slug here for consistency
        "description": "Purchase resources from the market.",
        "duration": 0, # Example duration, adjust as needed
        "submit_text": "Buy Resources",
        "inputs": [
            {"name": "resource_type", "label": "Resource Type:", "type": "select", "required": True, "options_url": "/realm/get_resource_types_json/"},
            {"name": "quantity", "label": "Quantity:", "type": "number", "required": True, "default": 1},
            {"name": "knowledge_economics_modifier", "label": "Knowledge (Economics) Modifier:", "type": "number", "required": True, "default": 0}
        ]
    }
