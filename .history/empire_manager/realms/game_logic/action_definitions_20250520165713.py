AVAILABLE_ACTIONS = {
    ...
    # Add "Start Mining" and "Train Infantry" if they are always available or tied to a season
    "All": ["Start Mining", "Train Infantry", "Recruit Population"], # Example for actions available in all seasons
}