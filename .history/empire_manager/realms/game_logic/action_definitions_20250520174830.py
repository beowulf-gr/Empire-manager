...
ALL_GAME_ACTIONS = {
    "Cultivate Fields": {
        "name": "Cultivate Fields", # <--- ADD THIS
    ...
    "Recruit Peasants": {
        "name": "Recruit Peasants", # <--- ADD THIS
    ...
    "Construct Building": {
        "name": "Construct Building", # <--- ADD THIS
    ...
    "Survey Resources": {
        "name": "Survey Resources", # <--- ADD THIS
    ...
    "Research Technology": {
        "name": "Research Technology", # <--- ADD THIS
...
ACTION_HANDLERS = {
    ...
    "recruit_population": {
        "module": "generic_actions", # New module
