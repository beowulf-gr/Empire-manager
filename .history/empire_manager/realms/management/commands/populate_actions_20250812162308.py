    ...
    def handle(self, *args, **kwargs):
        ...
        actions_to_create = [
            ...
            },
            {
                ...
                "description": "Assign free population units to strongholds to transform raw resources into finished products", "duration": 1,
                "submit_text": "Produce Goods", "descriptors": [], "seasons": [], # All seasons,
                "inputs": [
                    {
                        "name": "stronghold_name", "label": "Stronghold Name (Optional):", "type": "text",
