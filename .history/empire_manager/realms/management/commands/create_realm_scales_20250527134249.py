...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        realm_scales = [
            {"name": "Barony", "description": "A small realm, typically ruled by a baron or baroness.", "pop_unit_size": 10, "land_unit_size": 1, "gold_unit_value": 1000, "military_unit_size": 150},
            {"name": "Kingdom", "description": "A larger realm, ruled by a king or queen.", "pop_unit_size": 1000, "land_unit_size": 20, "gold_unit_value": 10000, "military_unit_size": 750},
            {"name": "Empire", "description": "A vast realm, often consisting of multiple kingdoms.", "pop_unit_size": 10000, "land_unit_size": 400, "gold_unit_value": 100000, "military_unit_size": 1500},
        ...
        for scale in realm_scales:
            ...
            realm_scale, created = RealmScale.objects.get_or_create(
                ...
                defaults={"description": scale["description"],
                          ...
                          "military_unit_size": scale["military_unit_size"]}
            )
