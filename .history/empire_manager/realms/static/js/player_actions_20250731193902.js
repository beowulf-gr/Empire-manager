        ...
        try {
            ...
            data.forEach(option => {
                ...
                if (url.includes('get_resource_types_json')) {
                    allResourcesData.push({ ...option, value_numeric: parseFloat(option.value) });
                } else if (url.includes('get_goods_types_json')) {
                    allGoodsTypesData.push({ ...option, value_numeric: parseFloat(option.value) });
                }
    ...
    actionButtons.forEach(button => {
        button.addEventListener('click', async function(event) {
            ...
            if (actionKey === 'construct_stronghold') {
                ...
                // Generic handler for "Buy Resources", "Buy Goods", "Recruit Population"
                ...
                if (actionKey === "buy_resources") {
                    ...
                    previewP.id = 'buy-preview-internal';
                    ...
                    const goodsSelect = document.getElementById('good_type_id');
                    const quantityInput = document.getElementById('quantity');
                    const previewP = document.createElement('p');
                    previewP.id = 'buy-preview-internal';
                    dynamicInputsDiv.appendChild(previewP);
