...
urlpatterns = [
    ...
    path('<str:realm_name>/get_all_producible_goods_json/', views.get_all_producible_goods_json, name='get_all_producible_goods_json'),
    path('<str:realm_name>/get_strongholds_for_good_json/<int:good_type_id>/', views.get_strongholds_for_good_json, name='get_strongholds_for_good_json'),
    path('get_good_details_json/<int:good_type_id>/', views.get_good_details_json, name='get_good_details_json'),
    path('<str:realm_name>/get_resources_by_category_json/<str:category_name>/', views.get_resources_by_category_json, name='get_resources_by_category_json'),
