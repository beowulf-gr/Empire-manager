...
def edit_land(request, realm_name=None):
    ...
    LandUnitFormSet = modelformset_factory(LandUnit, fields=('name', 'unit_type', 'production', 'harvest', 'settlement_capacity', 'assigned_population', 'upgrades', 'mineral_type'), extra=0)
