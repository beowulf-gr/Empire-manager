...
class Resource(models.Model):
    ...
    value = models.DecimalField(max_digits=10, decimal_places=4, default=1) # Base value of the resource
...
class GoodsType(models.Model):
    ...
    cost_resource = models.ForeignKey(
        ...
        null=True,  # Allow goods to have no resource cost, or to be "free"
        blank=True
    )
